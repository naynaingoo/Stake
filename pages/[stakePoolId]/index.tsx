import Navbar from 'acompoents/Navbar/NavbarStake';
// import '../../node_modules/bootstrap/dist/css/bootstrap.css';
import Footer1 from '../../acompoents/Footer/Footer';
import Simg from '../../images/UNSTAKE.png';
import USimg from '../../images/UNSTAKE (1).png';
...
function Home() {
  ...
  return (
    ...
    >
      <Head>
        <title>STREET SCIENTISTS | STAKE</title>
        <meta name="description" content="Generated by MK" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header />
      <Navbar />
      <div
        className={`container  py-8 my-2 rounded mx-auto w-full`}
        style={{
      ...
      >
        {(!stakePool && stakePoolLoaded) || stakePoolMetadata?.notFound ? (
          <div
            className="mx-5 mb-5 bg-green-900 rounded-md border-[1px] bg-opacity-40 p-4 text-center text-lg font-semibold"
            style={{
              background:
        ...
        {(maxStaked || rewardDistributorData) && !stakePoolMetadata?.notFound && (
          <div
            ...
            // }
            className={`mx-5 mb-4 bg-zinc-800 flex flex-wrap items-center gap-4 rounded-md px-10 py-6  md:flex-row md:justify-between `}
            style={{
        ...
        <div className="my-2 mx-5  grid grid-cols-1 gap-20 relative md:grid-cols-2 mt-20">
          <div className="imgs absolute">
            <div className="USimg cursor-pointer" onClick={() => {
              ...
              <Image src={Simg} width={130} height={100} />
            </div>
            <div className="Simg cursor-pointer" onClick={() => {
              ...
              <Image src={USimg} width={130} height={100} />
            </div>
          </div>
          {/* ${stakePoolMetadata?.colors?.fontColor
                ? `text-[${stakePoolMetadata?.colors?.fontColor}]`
          ...
          <div
            className={`flex-col rounded-md p-10 bg-zinc-800 mr-9`}
            style={{
              // background: stakePoolMetadata?.colors?.backgroundSecondary,
              border: stakePoolMetadata?.colors?.accent
                ? `2px solid ${stakePoolMetadata?.colors?.accent}`
          ...
          >
            <div className="mt-2 flex w-full flex-row justify-between bg-pgri">
              ...
              <div className="flex flex-row">
                {!stakePoolMetadata?.hideAllowedTokens && (
                  <button
                    ...
                    className="text-md mr-5 hidden inline-block rounded-md bg-white bg-opacity-5 px-4 py-1 hover:bg-opacity-10 focus:outline-none"
                  >
              ...
              <div className="flex gap-5">
                ...
                <MouseoverTooltip title="Attempt to stake all tokens at once">
                  <button
                    ...
                    className="my-auto bg-sky-500 flex cursor-pointer rounded-md px-4 py-2 hover:scale-[1.03]"
                  >
                    <span className="mr-1 inline-block">
                      {loadingStake && (
                        <LoadingSpinner
                    ...
                    <span className="my-auto font-bold">Stake All</span>
                  </button>
                </MouseoverTooltip>
              </div>
            </div>
          ...
          */}
          {/* ${stakePoolMetadata?.colors?.fontColor ? '' : 'text-gray-200'
              ...
              //  bg-white bg-opacity-5 */}
          <div
            className={`rounded-md p-10 bg-zinc-800 ml-9
                          ...
                          <div className="relative w-44 md:w-auto 2xl:w-48">
                            ...
                            >
                              ...
                              >
                                ...
                                />
                                <div
                                  className={`flex-col rounded-b-xl p-2 md:w-39 2xl:w-48 ${stakePoolMetadata?.colors?.fontColor
                                    ? `text-[${stakePoolMetadata?.colors?.fontColor}]`
                                    : 'text-gray-200'
                                    } ${stakePoolMetadata?.colors
                                      ?.backgroundSecondary
              ...
              <div className="flex gap-5">
                ...
                <MouseoverTooltip title="Attempt to unstake all tokens at once">
                  <button
                    ...
                    className="my-auto bg-red-600 flex cursor-pointer rounded-md px-4 py-2 hover:scale-[1.03]"
                  >
                    <span className="mr-1 inline-block">
                      {loadingUnstake && (
                        <LoadingSpinner
                    ...
                    <span className="my-auto font-bold">Unstake All</span>
                  </button>
                </MouseoverTooltip>
              </div>
